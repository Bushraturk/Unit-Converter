...
#  }
#  .stApp {
#         background-color: linear-gradient(135deg,rgb(100, 97, 97),rgb(92, 58, 58)
#         padding: 30px;
#         border-radius: 15px;
...
# st.write("Convert between different units of length, weight, and temperature", unsafe_allow_html=True)

# # sidebar menu
# conversion_type = st.sidebar._selectbox("Choose conversion type", ["Length", "Weight", "Temperature"])
...
#     with col1:
#         from_unit = st.selectbox("From", ["Meters", "Kilogram", "Centimeters", "Millimeters", "Feet", "Inches", "Yards", "Miles"])
#     with col2:
#         to_unit = st.selectbox("To", ["Meters", "Kilogram", "Centimeters", "Millimeters", "Feet", "Inches", "Yards", "Miles"])
...
#         return value -273.15 if to_unit == "Celsius" else (value -273.15) * 9/5+32 if to_unit == "Farrenheit" else value
#     return value 
...
# # ... existing code ...            
# st.markdown(f"<div class='result-box'>{value} {from_unit} = {result-box:.4f} {to_unit}</div>", unsafe_allow_html=True)
